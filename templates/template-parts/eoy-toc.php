<section class="eoy-toc">
    <div class="container">
        ...
        <div class="button-container ">
            <a href="#economic-prosperity"><button class='ibm-plex-sans' id="btn-mustard">Economic<br>Prosperity</button></a>
            <a href="#confidence-agency"><button class='ibm-plex-sans' id="btn-violet">Confidence<br>& Agency </button></a>
