<section class="eoy-confidence">
    <div class="container">
        ...
        <div class='confidence-heading'>
            <img id='confidence-stars' src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/eoy-2025/Stars/Property 1=Variant2.png" alt="">
            <h2 class='ibm-plex-sans'>Confidence and Agency</h2>
        </div>
        ...
        <div class='confidence-text'>
            <div>
                ...
                <p class='nunito-sans' style="margin-top: 10px;">This year, our members reported dramatic increases in their ability to navigate their futures. <span style="font-weight: 700;"> When NESTers exercise their agency to follow their dreams, transformation begins.</span></p>
            </div>
            <ul>
